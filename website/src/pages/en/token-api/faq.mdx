...
The Token API currently tracks prices on Uniswap v2, v3, and v4, along with Jupiter and Raydium on Solana, with plans to support additional exchanges in the future.
